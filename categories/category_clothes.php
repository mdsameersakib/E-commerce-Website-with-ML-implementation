...
<div class="flex flex-col md:flex-row justify-between items-baseline mb-8 gap-4 border-b border-white/5 pb-4">
    <div>
        <h1 class="text-3xl font-extrabold tracking-tight">Clothes</h1>
        <p class="text-sm text-base-content/50 mt-1">Browse premium products in our Clothes department</p>
    </div>
